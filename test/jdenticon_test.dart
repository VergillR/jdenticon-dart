...
void main() {
  const word1 = 'Omega';
  const svgCorrespondingToWord1 = '<svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" viewBox="0 0 64 64" preserveAspectRatio="xMidYMid meet"><path fill="#e5e5e5" d="M18 8a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M34 8a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M34 56a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M18 56a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M2 24a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M50 24a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M50 40a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0M2 40a5,5 0 1,1 10 ,0a5,5 0 1,1 -10,0" /><path fill="#999332" d="M0 16L0 16L0 0L16 0ZM48 0L48 0L64 0L64 16ZM64 48L64 48L64 64L48 64ZM16 64L16 64L0 64L0 48Z" /><path fill="#ccc666" d="M22 32a9,9 0 1,1 19 ,0a9,9 0 1,1 -19,0" /></svg>';
